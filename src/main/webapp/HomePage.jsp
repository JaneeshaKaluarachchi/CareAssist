...
<body>
    ...
    <div class="container">
        ...
        <div class="text-section">
            ...
            <div class="buttons">
                <a href="userLogin.jsp" class="login-btn">Log In</a>
                <a href="userLogin.jsp" class="signup-btn">Sign Up</a>
            </div>
        </div>
    </div>
    ...
    <div class="cao-section">
        <div class="cao-box pharmacy">
          <div class="cao-content">
            ...
            <div class="cao-actions">
              ...
              <button class="btn dark"><a href="userLogin.jsp">Order Now</a></button> sy
            </div>
          </div>
        </div>
        ...
        <div class="cao-box labs">
          <div class="cao-content">
            ...
            <p>Your paragraph text qwertyzxcvbnzcvbnsedrfgh dfg dfg sdfgh sdfgh dfg...</p>
            <div class="cao-actions">
              <button class="btn dark"><a href="userLogin.jsp">Test Now</a></button>
              <a href="#" class="read-more">Read More -></a>
            </div>
          </div>
        </div>
